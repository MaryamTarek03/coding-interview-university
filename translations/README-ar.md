...
**---------------- اي شيء تحت هذه فهو اختياري ----------------**

### مفاهيم ومصادر اضافية (اختيارية)

- [Additional Books](#additional-books)
- [System Design, Scalability, Data Handling](#system-design-scalability-data-handling) (اذا كان لديك 4 سنين من الخبرة)
...
ان كنت تريد ان تعمل كمهندس برمجبات لدى شركة كبيرة, هذه الاشياء التي يجب ان تعرفها.
...
انا استخدم ال Markdown الخاص ب "Github", اللتي تشمل قوائم المهام لمتابعة التقدم.
[المزيد عن GitHub Markdown](https://guides.github.com/features/mastering-markdown/#GitHub-flavored-markdown)

## ان كنت لا تريد استخدام Git
في هذه الصفحة, اضغط علي زر "Code" المتواجد بالقرب من الاعلى ثم اضغط على "Download ZIP". استخرج الملف ثم يمكنك العمل عليه.
...
أنشئ فرعًا جديدًا لتتابع التقدم بوضع علامة (x) داخل الأقواس: `[x]`
...
- هذه الفيديوهات يمكن أن تساعدك على تجاوز هذه المشاعر:
    - (أسطورة المبرمج العبقري) [The myth of the Genius Programmer](https://www.youtube.com/watch?v=0SARbwvhupQ) 
    - (من الخطر الذهاب وحدك: محاربة الوحوش الخفية في التقنية)[It's Dangerous to Go Alone: Battling the Invisible Monsters in Tech](https://www.youtube.com/watch?v=1i8ylq4j_EY) 
...
ستحتاج الى اختيار لغة برمجة لاستخدامها في مقابلات العمل,

لكنك ستحتاج ايضاً اللي ايجاد لغة لمذاكرة مفاهيم علوم الحاسب.
...
* **لغة C**: لغة منخفضة المستوى تمكّنك من التعامل مع المؤشرات (Pointers) وإدارة الذاكرة بشكل مباشر، مما يساعدك على فهم هياكل البيانات والخوارزميات من الأساس. 
	- في لغات البرمجة عالية المستوي مثل Python او Java, هذه الاشياء مخفية عنك, وهو شيء سيء, لكن عندما تتعلم كيف تعمل هياكل البيانات منخفضة المستوى, سوف  تشعر بأنك اقرب للآله.
    - لغة ال C في كل مكان, ستجدها في امثلة الكتب, المحاضرات, الفيديوهات, *في كل مكان* تدرس فيه.
    - [The C Programming Language, 2nd Edition](https://www.amazon.com/Programming-Language-Brian-W-Kernighan/dp/0131103628)
        - هذا كتابُ قصير, لكنه سيساعدك في التعامل مع لغة ال C و ان قمت بالتدرب قليلاً ستكون كفء بسرعة, فهم C يساعدك على فهم كيفية عمل البرامج والذاكرة
        - لا تحتاج ان تتعمق كثيراً في الكتاب (او حتى انهائه). فقط عندما تجد نفسك مرتاحا في كتابة و قراءة C.
...
من المهم أن تكون مرتاح جدًا مع اللغة التي تختارها، وأن تكون على دراية جيدة بها.
...
هذا الكتاب سيكون اساسك في علوم الحاسب

فقط اختر واحداً, في اللغة التي تشعر بالراحة معها, فأنك سوف تقرأ وتبرمج كثيراً
...
- [Coding Interview Patterns: Nail Your Next Coding Interview](https://geni.us/q7svoz) (**التوصية الرئيسية**)
    ...
    - شرح بسيط يوجهك في كل مسألة مأنك في مقابلة مباشرة.
    - اكثر من 1000 مخطط لتوضيح المفاهيم الاساسية والانماط. 

### C

- [Algorithms in C, Parts 1-5 (Bundle), 3rd Edition](https://www.amazon.com/Algorithms-Parts-1-5-Bundle-Fundamentals/dp/0201756080)
    - الاساسيات, هياكل البيانات, الترتيب, و الجوريزمات ال Graph
...
- [Programming Interviews Exposed: Coding Your Way Through the Interview, 4th Edition](https://www.amazon.com/Programming-Interviews-Exposed-Through-Interview/dp/111941847X/)
    - الاجابات بلغة C++ و Java
    - هذا يُعد تمرينًا تمهيديًا جيدًا لكتاب Cracking the Coding Interview
    - ليس صعباً جدًا، فمعظم المشاكل قد تكون أسهل مما ستواجهه في مقابلة العمل (وفقًا لما قرأت).
...
اليك بعض الأخطاء الذي فعلتها ليمكنك الحصول على تجربة افضل, وتنقذ شهوراً من الوقت
...
ارجوك, اقرأ لتجنب اخطائي:

[Retaining Computer Science Knowledge](https://startupnextdoor.com/retaining-computer-science-knowledge/).

### 2. استخدم بطاقات المراجعة (Flashcards)

لحل هذه المشكلة, صنعت موقع Flashcard بسيط حيث يمكنني ان اضُيف بطاقات من نوعين: عادية و كود. كل بطاقة لها تنسيقُُ مختلف. صنعت الموقع لخدمة الهواتف اولاً, لذا يكون بامكاني المراجعة من هاتفي اينما كنت.

اصنع الموقع الخاص بك مجاناً:

- [Flashcards site repo](https://github.com/jwasham/computer-science-flash-cards)

**انا لا اوصي باستخدام بطاقاتي (Flashcards)** اغلبهم تفاهاتُُ لا تحتاجُها.

لكن اذا كنت لا تُريد الاستماع الّي, خذ ها هم:
- [My flash cards database (1200 cards)](https://github.com/jwasham/computer-science-flash-cards/blob/main/cards-jwasham.db):
- [My flash cards database (extreme - 1800 cards)](https://github.com/jwasham/computer-science-flash-cards/blob/main/cards-jwasham-extreme.db):

ضع في اعتبارك أنني بالغت قليلًا، حيث أنشأت بطاقات تغطي كل شيء بدءًا من لغة Assembly ومعلومات دقيقة عن Python، وصولًا إلى تعلم الآلة والإحصاء.
انها كثيرة جداً لما تحتاجه.

**ملاحظة عن ال Flashcards:** في أول مرة تشعر أنك تعرف الإجابة، لا تقوم بتحديد البطاقة على أنها "معروفة". يجب أن تري نفس البطاقة وتجيب عنها بشكل صحيح لعدة مرات قبل أن تترسخ فعليًا في ذاكرتك. **التكرار** هو الذي يعمّق المعلومة داخل عقلك.

بديل لاستخدام موقعي الخاص بالبطاقات هو [Anki](http://ankisrs.net/)
وقد تم ترشيحه لي مرارًا وتكرارًا. يعتمد على نظام التكرار لمساعدتك على التذكر. يتميز بسهولة الاستخدام، متوفر على جميع المنصات، ويحتوي على خاصية المزامنة عبر السحابة. يبلغ سعره 25 دولارًا على iOS، لكنه مجاني على باقي المنصات.
